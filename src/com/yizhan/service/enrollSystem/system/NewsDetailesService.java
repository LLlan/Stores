...
public class NewsDetailesService {
	...
	public List<PageData> getlistPage(Page page) throws Exception{
		return (List<PageData>) dao.findForList("newsDetailesMapper.getlistPage", page);
	}
	/**
	 * 获取列表
	 * @param page
	...
	public List<PageData> getList(PageData pd) throws Exception{
		return (List<PageData>) dao.findForList("newsDetailesMapper.getList", pd);
	}
	...
	public void insert(PageData pd) throws Exception{
		dao.save("newsDetailesMapper.insert", pd);
	}
	...
	public void update(PageData pd) throws Exception{
		dao.update("newsDetailesMapper.update", pd);
	}
	...
	public void delete(Map<String, Object> map) throws Exception{
		dao.delete("newsDetailesMapper.delete", map);
	}
