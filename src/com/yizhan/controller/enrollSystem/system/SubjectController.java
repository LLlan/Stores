...
import com.yizhan.service.enrollSystem.system.SubjectService;
...
public class SubjectController extends BaseController{
	 ...
	 * @throws Exception 
	 */
	@RequestMapping(value="/subjectlistPage")
	public ModelAndView subjectlistPage(Page page) throws Exception{
		...
		List<PageData> list=subjectService.subjectlistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		
		mv.setViewName("enrollSystem/system/subject/subject_list");
		return mv;
	}
	/**
	 * 进入添加页面
	...
	public ModelAndView toAdd(){
		...
		mv.setViewName("enrollSystem/system/subject/subject_edit");
		return mv;
	}
	/**
	 * 添加信息
	...
	public ModelAndView insert() throws Exception{
		...
		savePd.put("subject_id", this.get32UUID());
		savePd.put("subjectName", pd.getString("subjectName"));
		
		subjectService.insert(savePd);
	...
	public ModelAndView toEdit() throws Exception{
		...
		//获取指定对象信息
		pd=subjectService.getDateById(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView update() throws Exception{
		...
		updatePd.put("subject_id", pd.getString("subject_id"));
		updatePd.put("subjectName", pd.getString("subjectName"));
		
		subjectService.update(updatePd);
		mv.addObject("msg","success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public Object getDateByName() throws Exception{
		...
		selectPd.put("subjectName", pd.getString("subjectName"));
		selectPd=subjectService.getDateByName(selectPd);
	...
	public void delete(PrintWriter writer) throws Exception{
		...
		/*List<PageData> paths=subjectService.getListByIds(map);
