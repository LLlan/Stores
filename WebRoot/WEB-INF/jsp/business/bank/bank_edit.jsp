...
<body>
	<form action="bank/${msg }.do" id="residenceForm" method="post">
		...
		<table class="table table-striped table-bordered">
			...
			<tr>
				<td>银行：</td>
				<td>
				     <input type="text" placeholder="请输入银行" name="bank_name" id="bank_name" value="${pd.bank_name }" maxlength="32" class="inputClass"  title=""/>             
				</td>
			</tr>
			...
			<tr>
				<td>卡号：</td>
				<td>
				     <input type="text" placeholder="请输入卡号" name="card_number" id="card_number" value="${pd.card_number }"  class="inputClass"  title=""/>             
				</td>
			</tr>
			<tr>
				<td>户名：</td>
				<td>
				     <input type="text" placeholder="请输入户名" name="card_huming" id="card_huming" value="${pd.card_huming }" maxlength="32" class="inputClass"  title=""/>             
				</td>
			</tr>
