...
<body>
	<form action="kehu/${msg }.do" id="residenceForm" method="post">
		<input type="hidden" name="kehu_id" id="kehu_id" value="${pd.kehu_id}"/>
		<div id="zhongxin">
		<table class="table table-striped table-bordered">
			<tr>
			<td width="110px;">客户名称：</td>
				<td>
					<input type="text" placeholder="请输入客户名称" name="kehu_name" id="kehu_name" value="${pd.kehu_name }" maxlength="50" class="inputClass"  title=""/>
				</td>
			</tr>
			...
			<tr>
				<td>地址：</td>
				<td>
				     <input type="text" placeholder="请输入地址" name="address" id="address" value="${pd.address }" maxlength="32" class="inputClass"  title=""/>             
				</td>
			</tr>
			...
			<tr>
				<td>联系方式：</td>
				<td>
				     <input type="text" placeholder="请输入联系方式"  name="contact" id="contact" value="${pd.contact }" maxlength="32" class="inputClass" title=""/>             
				</td>
			</tr>
