...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="stock/stockListPage.do" method="post" name="residenceForm" id="residenceForm">
			<table>
				<tr>
					<td>
		...
		<tbody>
				...
				<c:choose>
					<c:when test="${not empty stockList}">
						<c:if test="${QX.cha == 1 }">
						<c:forEach items="${stockList}" var="rlist" varStatus="vs">
							...
							<%-- 	<td class='center' style="width: 30px;">
								...
								<td>${rlist.stock_name}</td>
								<td>${rlist.store_goods }</td>
								<td>${rlist.stock_mianji }</td>
								<td>
