...
<body>
	<form action="merchant/${msg }.do" id="residenceForm" method="post">
		<input type="hidden" name="merchant_id" id="merchant_id" value="${pd.merchant_id}"/>
		<div id="zhongxin">
		<table class="table table-striped table-bordered">
			<tr>
			<td width="110px;">商家名字：</td>
				<td>
					<input type="text" placeholder="请输入商家名字"  name="merchant_name" id="merchant_name" value="${pd.merchant_name }" maxlength="50" class="inputClass" title=""/>
				</td>
			</tr>
			
		 	<tr>
				<td>地址：</td>
				<td><input type="text" placeholder="请输入地址" name="address" id="address" value="${pd.address }" maxlength="32" class="inputClass"  title=""/></td>
			</tr> 
			
			<tr>
				<td>电话：</td>
				<td>
				     <input type="text" placeholder="请输入电话"  name="phone" id="phone" value="${pd.phone }"  class="inputClass" title=""/>             
				</td>
			</tr>
