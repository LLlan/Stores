...
<div class="contentDiv">
    ...
    <div class="middleDiv">
        <span></span><span>新闻资讯</span><span></span>
    </div>
    <ul class="bottomDiv">
    	<c:forEach items="${list }" var="va">
    		<li onclick="window.location.href='api/customerOperation/newsList.do?news_module_id=${va.news_module_id}'">
	            <a href="javascript:void(0)">
	            	<img src="${va.icon_path }">
	            	<p>${va.news_module_name }</p>
	            </a>
	        </li>
    	</c:forEach>
    	<!--  
