...
<body>
	<form action="api/contactUs/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="contact_us_id" value="${pd.contact_us_id}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td>标题:</td>
				<td>
					<input type="text" name="title" id="title" value="${pd.title }" placeholder="请输入。。。"/>
				</td>
			</tr>
			<tr>
				<td>内容:</td>
				<td>
					<textarea name="content" id="content" placeholder="请输入。。。">${pd.content }</textarea>
				</td>
			</tr>
			<tr>
				<td>排列序号:</td>
				<td><input type="number" name="sort" id="sort" placeholder="请输入。。。" value="${pd.sort }"/></td>
			</tr>
			<tr>
