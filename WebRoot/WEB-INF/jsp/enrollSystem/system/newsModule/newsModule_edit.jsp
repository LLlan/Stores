...
<body>
	<form action="api/newsModule/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		<input type="hidden" name="news_module_id" value="${pd.news_module_id}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td>工种名称:</td>
				<td>
					<input type="text" name="news_module_name" id="news_module_name" value="${pd.news_module_name }" placeholder="输入模块名称"/>
				</td>
			</tr>
			<tr>
				<td>图标:</td>
				<td>
					...
					<c:if test="${pd != null && pd.icon_path != '' && pd.icon_path != null }">
						...
						<input type="button" class="btn btn-mini btn-danger" value="删除" onclick="delP('${pd.icon_path}','${pd.news_module_id }');" />
