...
<body>
	<form action="api/expertPosition/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="expert_position_id" value="${pd.expert_position_id}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td>专家职称:</td>
				<td>
					<input type="text" name="position" id="position" value="${pd.position }" placeholder="请输入。。。"/>
				</td>
			</tr>
			<tr>
...
<script type="text/javascript">
	...
	function save(){
		...
		$.post('api/expertPosition/getDateByName.do',{position:$("#position").val()},function(data){
			if(data.respCode=='01'){
				$("#Form").submit();
			}else{
				$("#position").tips({
